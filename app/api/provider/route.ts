...
export async function POST(request: Request) {
  ...
  try {
    ...
    return safeJson({ error: code }, code === 'unconfigured' || code === 'busy' ? 409 : code === 'timeout' ? 504 : code === 'upstream' ? 502 : code === 'unauthorized' ? 401 : code === 'not_found' ? 404 : code === 'rate_limited' ? 429 : 400);
  }
}
